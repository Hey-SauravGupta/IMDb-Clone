...
// //         (function(){
// //           axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=a61b1b9d8f917da422a3b732e1519857&page=${pageNum}`).then((res)=>{
...
// //                className='w-[160px] h-[35vh] bg-center bg-cover rounded-xl m-4 md:h[40vh]' 
// //                style={{
...
//         <div className='text-2xl mb-8 font-bold text-center text-red-600'>
//           Tranding... Movies
//         </div>
    ...
    <div className='bg-gray-800'>
        ...
        <div className='flex flex-wrap'>
          {movies.map((movie)=>{
               ...
               key={movie.id} className='w-[160px] h-[35vh] bg-center bg-cover rounded-xl m-4 md:h[40vh] md:w[200px] hover:scale-110 duration-300 relative flex items-end'
